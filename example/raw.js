var createSocket = (typeof require !== 'undefined')?function(url){
  var sjsc = require('sockjs-client-ws');
  client = sjsc.create(url);
  Object.defineProperty(client,"onopen",{set:function(cb){
    this.on("connection",cb);
  }});
  Object.defineProperty(client,"onmessage",{set:function(cb){
  ...
  return client;
}:function(url){return new SockJS(url);};
      ...
      var thisSocket = {
        ...
        emit:{
          ...
          init:function(qId,data){
            thisSocket.sockets[qId].send(JSON.stringify({event:"SodaPurchase.purchaser::init",data:data}));
          },
          spendMoney:function(qId,agentData,data){
            ...
            thisSocket.sockets[qId].send(JSON.stringify({event:"SodaPurchase.purchaser::spendMoney:"+agentData._id,data:data}));
          },
          selection:function(qId,agentData,data){
            ...
            thisSocket.sockets[qId].send(JSON.stringify({event:"SodaPurchase.purchaser::selection:"+agentData._id,data:data}));
          },
          getMoneyBack:function(qId,agentData,data){
            ...
            thisSocket.sockets[qId].send(JSON.stringify({event:"SodaPurchase.purchaser::getMoneyBack:"+agentData._id,data:data}));
          },
          isUnHappy:function(qId,agentData,data){
            ...
            thisSocket.sockets[qId].send(JSON.stringify({event:"SodaPurchase.purchaser::isUnHappy:"+agentData._id,data:data}));
          },
          isHappy:function(qId,agentData,data){
            ...
            thisSocket.sockets[qId].send(JSON.stringify({event:"SodaPurchase.purchaser::isHappy:"+agentData._id,data:data}));
          }
        },
        on:{
