...
function createScaffold(appname) {
  ...
  [ "modules", "modules/conversation", 'modules/conversation/partial', 'modules/conversation/controller','modules/conversation/controller/custom', 'modules/conversation/locale', 'gruntTasks', "components", 'constant', 'service', 'libs', 'compiled_modules', "less", "styles"].forEach(
      function(directory) {
...
function createProject(spec) {
  ...
  var doStuff = function() {
    ...
    cp.spawn('npm',['install'], path.resolve(appname),
      function (error) {
        if (error) {
