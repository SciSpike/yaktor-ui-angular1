...
var fs = require('fs'),
  ...
  json2angular = {},
  templates = {},
  ignoreFileTypes = /\.(eot|otf|svg|ttf|woff|woff2)$/i
...
function createTemplate (appname, filename, data) {
  ...
  if(ignoreFileTypes.test(filename)){
    console.log('SKIPPING THE FUTZ', filename);
...
function createScaffold (appname) {
  ...
  ;[ 'generated', 'generated/crud', 'generated/agents', 'generated/controllers', 'generated/directives', 'generated/services', 'generated/locale', 'gruntTasks', 'libs', 'libs/vendor', 'styles', 'styles/css', 'generated/partials', 'generated/partials/crud', 'generated/partials/agents', 'client', 'cordova_template' ]
