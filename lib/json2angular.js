...
function createScaffold (appname) {
  ...
  [ 'generated', 'generated/crud', 'generated/agents', 'generated/controllers', 'generated/directives', 'generated/services', 'generated/locale', 'gruntTasks', 'libs', 'libs/vendor', 'styles', 'styles/css', 'generated/partials', 'generated/partials/crud', 'generated/partials/agents','shared', 'shared/modules', 'client', 'cordova_template' ]
	    ...
	    fs.mkdir(path.join(path.resolve(appname), 'generated', 'crud', crudSpec.name, 'controllers'), function (response) {
	      ...
	      fs.mkdir(path.join(path.resolve(appname), 'generated', 'partials', 'crud', crudSpec.name), function (response) {
	        ...
	        if (crudSpec.actions.elements) {
              ...
              console.log("*********   CHILD ELEMENTS", crudSpec.actions.elements[childState]);
