(function() {
  ...
  function createActionableElement(stateName, elementName, type, ui, rest) {
    ...
    var view, fragmentPath, source, fragment;
    var fragmentDir = path.join(__dirname, '..', 'template', 'fragment');
    ...
    if (type) {
      ...
      case "toggle":
        ...
        fragmentPath = path.join(fragmentDir, 'toggle.html');
        source = fs.readFileSync(fragmentPath, 'utf8');
        fragment = mustache.render(source, view);
      ...
      case "checkbox":
        ...
        fragmentPath = path.join(fragmentDir, 'checkbox.html');
        source = fs.readFileSync(fragmentPath, 'utf8');
        fragment = mustache.render(source, view);
      ...
      case "radio":
        ...
        fragmentPath = path.join(fragmentDir, 'radio.html');
        source = fs.readFileSync(fragmentPath, 'utf8');
        fragment = mustache.render(source, view);
      ...
      case "enum":
        ...
        fragmentPath = path.join(fragmentDir, 'enum.html');
        source = fs.readFileSync(fragmentPath, 'utf8');
        fragment = mustache.render(source, view);
      ...
      case "date":
        ...
        fragmentPath = path.join(fragmentDir, 'date.html');
        source = fs.readFileSync(fragmentPath, 'utf8');
        fragment = mustache.render(source, view);
      ...
      case "submit":
        ...
        fragmentPath = path.join(fragmentDir, 'submit.html');
        source = fs.readFileSync(fragmentPath, 'utf8');
        fragment = mustache.render(source, view);
  ...
  function createState(appname, statename, description, layout, rest) {
    ...
    for (var name in elements) {
      ...
      var newPath = path.join(appname, 'partial', statename.camelize().s + '.' + name.camelize().s + '.html');
    ...
    var newPath = path.join(partialPath, statename.camelize().s + '.html');
    fs.renameSync(oldPath, newPath);
