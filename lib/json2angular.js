...
function createScaffold(appname) {
  ...
  [ "modules", "modules/conversation", 'modules/conversation/partial', 'modules/conversation/controller','modules/conversation/controller/custom', 'modules/conversation/locale', 'gruntTasks', "components", 'constant', 'service', 'libs', 'compiled_modules', "less", "styles", "locale", "controllers", "partials"].forEach(
      function(directory) {
