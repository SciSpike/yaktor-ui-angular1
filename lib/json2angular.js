...
function createScaffold(appname) {
  ...
  [ 'constant', 'service', 'partial', 'controller',"controller/custom" ].forEach(
      function(directory) {
...
//ADD THE GRUNT TASK HERE - AFTER THE APP HAS BEEN CREATED AND ALL THE FILES HAVE BEEN GENERATED
