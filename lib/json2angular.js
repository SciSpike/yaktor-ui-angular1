...
function createScaffold (appname) {
  ...
  [ 'generated', 'generated/crud', 'generated/agents', 'generated/controllers', 'generated/directives', 'generated/services', 'generated/utilities', 'generated/locale', 'gruntTasks', 'libs', 'libs/vendor', 'styles', 'styles/css', 'generated/partials', 'generated/partials/crud', 'generated/partials/agents','shared', 'shared/modules', 'client', 'cordova_template' ]
...
function createProject (spec, cb) {
	  ...
	  async.series([
			...
			function (cb) {
				var files = fs.readdirSync(path.join(__dirname, '../', 'template', 'generated', 'utilities'));
				async.each(files, function (file, cb) {
					checkIfFolder(appname, 'generated/utilities', file, moduleData, cb);
				}, cb);
			},
			function (cb) {
