(function () {
  ...
  function createTypeAhead (name, definition, typeRefs, style){
    ...
    console.log("type ahead name", name);
    var element = {};
  ...
  function createElement (name, definition, typeRefs) {
    ...
    if (definition.$typeRef) {
      return createTypeAhead(name, definition, typeRefs, "select");
    }
    ...
    if (definition.type === "array" && definition.items.type) {
      element.ui = definition;
      element.ui.title = titlize(name);
      //element.ui.items = createElement(name, definition.items, typeRefs);
        
      console.log("Array Element", element.ui);
